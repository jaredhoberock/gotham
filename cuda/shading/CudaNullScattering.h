...
#include "../../shading/functions/NullScatteringBase.h"
#undef inline

typedef NullScatteringBase<float3,float3,CudaDifferentialGeometry> CudaNullScattering;
...
//
//    inline __host__ __device__ float3 evaluate(void) const;
//
