...
template<typename PointType, typename RealType, size_t mNumDimensions>
...
template<typename PointType, typename RealType, size_t mNumDimensions>
  PointType &AxisAlignedHypercube<PointType, RealType, mNumDimensions>::operator[](const size_t i)
{
...
template<typename PointType, typename RealType, size_t mNumDimensions>
  const PointType &AxisAlignedHypercube<PointType, RealType, mNumDimensions>::operator[](const size_t i) const
{
  if(i == 0) return getMinCorner();
  ...
  RealType AxisAlignedHypercube<PointType, RealType, mNumDimensions>::computeVolume(void) const
{
  ...
  for(size_t dimension = 0; dimension < mNumDimensions; ++dimension)
  {
