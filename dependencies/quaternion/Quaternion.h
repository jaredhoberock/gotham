  ...
  : public gpcpu::float4
{
  public:
     ...
     */
    inline Quaternion(const gpcpu::float4 &v);

    /*! Constructor accepts an angle in radians, and an axis of rotation.
     *  \param angle The rotation angle in radians.
     *  \param axis The axis of rotation.
     */
    inline Quaternion(const float angle, const gpcpu::float3 &axis);
     ...
     */
    inline gpcpu::float4x4 getRotationMatrix(void) const;
