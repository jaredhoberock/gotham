...
#g.attribute("renderer::outfile", "rooms_with_roof.kajiya.constant.exr")

#g.attribute("importance::function", "equalvisit")
#g.attribute("renderer::outfile", "rooms_with_roof.kajiya.equalvisit.exr")

#g.attribute("importance::function", "luminanceovervisits")
#g.attribute("renderer::outfile", "rooms_with_roof.kajiya.luminanceovervisits.exr")

g.attribute("importance::function", "throughputluminance")
g.attribute("renderer::outfile", "rooms_with_roof.kajiya.throughputluminance.exr")

#g.attribute("importance::function", "luminance")
#g.attribute("renderer::outfile", "rooms_with_roof.kajiya.luminance.exr")
