/*! \file ConditionalEqualVisitImportance.h
 *  \author Jared Hoberock
 *  \brief Defines the interface to a ScalarImportance class whose
 *         importance is conditional on the other Path being considered.
 */

#ifndef CONDITIONAL_EQUAL_VISIT_IMPORTANCE_H
#define CONDITIONAL_EQUAL_VISIT_IMPORTANCE_H

#include "LuminanceOverVisits.h"

class ConditionalEqualVisitImportance
...
}; // end ConditionalEqualVisitImportance

#endif // CONDITIONAL_EQUAL_VISIT_IMPORTANCE_H
