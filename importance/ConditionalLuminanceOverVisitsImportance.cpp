/*! \file ConditionalLuminanceOverVisitsImportance.cpp
 *  \author Jared Hoberock
 *  \brief Implementation of ConditionalLuminanceVisitsImportance class.
 */
...
ConditionalLuminanceOverVisitsImportance
  ::ConditionalLuminanceOverVisitsImportance(const bool doInterpolate)
    :Parent(doInterpolate)
{
  ;
} // end ConditionalLuminanceOverVisitsImportance::ConditionalLuminaneOverVisitsImportance()

float ConditionalLuminanceOverVisitsImportance
             ...
             const std::vector<PathSampler::Result> &yResults)
{
  ...
  result = mLuminanceImportance(x,xPath,xResults);
  ...
  if(xRaster == yRaster)
  {
    // we're in the same bucket, return only brightness
    return result;
  } // end if
  ...
  return result;
} // end ConditionalLuminanceOverVisitsImportance::evaluate()
